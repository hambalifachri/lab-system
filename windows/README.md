...
`lab-login.ahk` adalah script AutoHotkey v2 untuk PC `SIPIL-01` sampai `SIPIL-25`.
...
1. Pastikan nama komputer Windows adalah `SIPIL-01` sampai `SIPIL-25`.
...
5. Jalankan `lab-login.ahk` sekali untuk pengujian. Halaman login harus membuka URL dengan `?pc=SIPIL-xx`.
